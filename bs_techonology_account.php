    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
                    ...
                    <div class="h-100 bg-secondary rounded p-4" style="overflow-x:auto;">
                        <div class="d-flex align-items-center justify-content-between mb-1">
                            ...
                            <div class="col-12 text-center text-sm-start">
                                <center><h2>BS TECHNOLOGY TRANSACTION</h2> 
            ...
            <?php
              ...
              $omc=$obj->bst_credit_monthly_sum();
              
            
              $odm=$obj-> bst_debit_monthly_sum();
            ...
            <center><h2>Overall</h2>   
                   ...
                   <br>
                    <br>
                            ...
                            var tabletab = document.getElementById("tabletab"), sumbs = 0;
                            
                            for(var i = 1; i < tabletab.rows.length; i++)
                            {
                                sumbs = sumbs  + parseInt(tabletab.rows[i].cells[2].innerHTML);
                            }
