    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
                    ...
                    <div class="h-100 bg-secondary rounded p-4" style="overflow-x:auto;">
                        <div class="d-flex align-items-center justify-content-between mb-1">
                            ...
                            <div class="col-12 text-center text-sm-start">
                                <center><h2 style="color:white;">BIDDABD TRANSACTION</h2> 
            ...
            <?php
              ...
              $obj = new Count();
              $bcd=$obj-> biddabd_credit_daily_sum();
             $omc=$obj->biddabd_credit_monthly_sum();
              $odb=$obj-> biddabd_debit_daily_sum();
              $bdw=$obj-> biddabd_debit_weekly_sum();
             $odm=$obj->biddabd_debit_monthly_sum();
                   ...
                   <div class="row g-4" hidden="hidden">
                        <div class="col-sm-12 col-xl-12">
                            <div class="bg-secondary rounded h-100 p-4">
                               ...
                               <table class="table table-bordered" id="table" style="border: 1px solid; border-color: white;">
                   ...
                   <div class="row g-4">
                        <div class="col-sm-12 col-xl-12">
                            <div class="bg-secondary rounded h-100 p-4">
                               ...
                               <table class="table table-bordered" id="tabletab" style="border: 1px solid; border-color: white;">
                                    <thead style="background-color: #D61355; color: black; text-align: center;">
                                        <tr> 			
                                            <th scope="col">Sl.No</th>
                                            <th scope="col">Description</th>
                            ...
                            <tr>
                                ...
                                <td id="koly"></td>
                                    ...
                                    <script>
                                        ...
                                        var tabletab = document.getElementById("tabletab"), sumkoly = 0;

                                        for(var i = 1; i < tabletab.rows.length; i++)
                                        {
                                        sumkoly= sumkoly+ parseInt(tabletab.rows[i].cells[2].innerHTML);
                                        }
